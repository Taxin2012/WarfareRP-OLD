...
ent:SetModel("models/z-o-m-b-i-e/st/box/part/st_box_metall_01_1.mdl")
local ent2 = ents.Create("prop_physics")
ent2:SetPos(self:GetPos())
ent2:SetAngles(self:GetAngles())
ent2:SetModel("models/z-o-m-b-i-e/st/box/part/st_box_metall_01_2.mdl")
ent2:Spawn()
ent:Spawn()
ent2:Activate()
ent:Activate()
...
local ent33 = ents.Create("nut_entbox")
ent33:SetPos(pos)
ent33:SetAngles(ang)
ent33:SetModel("models/z-o-m-b-i-e/st/box/st_box_metall_01.mdl")
ent33:Spawn()
ent33:Activate()
end)
if (ent:IsValid()) then
