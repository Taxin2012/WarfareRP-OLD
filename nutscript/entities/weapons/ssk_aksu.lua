...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_aksu.mdl"    
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/ak74u_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_ak74u_shot.wav"    
...
function SWEP:PrimaryAttack()
	...
	local rnda = self.Primary.Recoil * 0
	local rndb = self.Primary.Recoil * math.random(0, 0)
	self:ShootEffects()
...
SWEP.VmPos, SWEP.VmAng = Vector(4.25,2,-5.5), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.35,0,0.25), Angle(0,0,0)
