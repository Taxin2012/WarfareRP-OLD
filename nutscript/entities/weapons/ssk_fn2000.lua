...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_fn2000.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_fn2000.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "ar2"   
SWEP.Type = "rifle"                            
SWEP.PrintName = "ФТ-200М"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 4                              
SWEP.ReloadSound = "ssk/weapons/fn2000_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_fn2000_shot.wav"    
...
util.PrecacheSound("ssk/weapons/fn2000_grenload.wav")
...
if (self.Grena == true) then
self:FireRocket()
self.Weapon:SetNextPrimaryFire(CurTime() + 0.2)
self.Weapon:SetNextSecondaryFire(CurTime() + 0.2)
self.Weapon:EmitSound(Sound(self.gren))
self:SetClip1( 0 )
elseif (self.Grena == false) then
...
if self.Owner:GetAmmoCount( self.Primary.Ammo ) == 0 then return end if (self.Owner:GetActiveWeapon():Clip1() == self.Primary.ClipSize) then return end
    ...
    self.Weapon:EmitSound("ssk/weapons/fn2000_reload.wav")
    self:UpdateNextIdle()
...
SWEP.VmPos, SWEP.VmAng = Vector(3.5,1,-7), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(2.1,0,-1.3), Angle(0,0,0)
