...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_svd.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_svd.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "smg"   
SWEP.Type = "sniper"                       
SWEP.PrintName = "СВДм-2"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/svd_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_svd_shot.wav"    
...
SWEP.VmPos, SWEP.VmAng = Vector(3,0,-6), Angle(0,0,0)
