...
SWEP.Weight = 1                                   
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/hpsa_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_hpsa_shot.wav"    
SWEP.Primary.Damage = math.random(50, 60)                
...
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.4,0,1.6), Angle(0,0,0)
