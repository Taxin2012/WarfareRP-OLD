...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_walter.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_walter.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "pistol"   
SWEP.Type = "pistol"                     
SWEP.PrintName = "Волкер-П9м"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Primary.Sound = "ssk/weapons/n_walther_shot.wav"    
...
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.49,0,1.1), Angle(0,0,0)
