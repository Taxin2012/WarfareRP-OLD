...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_pro.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_pro.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 4                                
SWEP.HoldType = "ar2"   
SWEP.Type = "ar2"                     
SWEP.PrintName = "Отбойник"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.VmPos, SWEP.VmAng = Vector(0.5,9,-8), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(6.1,0,1), Angle(0,0,0)
