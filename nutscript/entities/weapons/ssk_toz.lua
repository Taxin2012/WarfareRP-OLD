...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_toz.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_toz.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 4                                
SWEP.HoldType = "shotgun"   
SWEP.Type = "shotgun"                     
SWEP.PrintName = "Охотничье ружьё"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Primary.Sound = "ssk/weapons/n_toz34_shot.wav"    
SWEP.Primary.Damage = math.random(12, 16)           
...
SWEP.ReloadSound = "ssk/weapons/toz34_reload.wav"
SWEP.ReloadLeftSound = "ssk/weapons/toz34_reload_one.wav"
SWEP.Anim = {}
...
function SWEP:PrimaryAttack()
	...
	elseif (self.Owner:GetActiveWeapon():Clip1() == 1) then
		...
		local bullet = {}
			...
			bullet.Spread = Vector( self.Primary.Spread * 0.2 , self.Primary.Spread * 0.2, 0)
...
SWEP.VmPos, SWEP.VmAng = Vector(6.2,0,-4.3), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(2.7,0,0.8), Angle(0,0,0)
