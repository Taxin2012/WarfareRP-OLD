...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_pkm.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_pkm.mdl"  
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/pkm_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/pkm_shot.wav"    
...
SWEP.VmPos, SWEP.VmAng = Vector(3,0,-4.5), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(2.4,0,2.6), Angle(0,0,0)
