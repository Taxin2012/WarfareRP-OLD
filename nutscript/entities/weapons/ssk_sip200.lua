...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_sig.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_sig.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "pistol"   
SWEP.Type = "pistol"                     
SWEP.PrintName = "СИП-т М200"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Primary.Sound = "ssk/weapons/n_sig220_shot.wav"    
...
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.5,0,1.3), Angle(0,0,0)
