...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_vintorez.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_vintorez.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "smg"   
SWEP.Type = "sniper"                            
SWEP.PrintName = "«Винтарь-ВС»"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 3                              
SWEP.ReloadSound = "ssk/weapons/vintorez_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_vintorez_shot.wav"    
...
SWEP.VmPos, SWEP.VmAng = Vector(3.5,0,-7), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.43,0,0.9), Angle(0,0,0)
