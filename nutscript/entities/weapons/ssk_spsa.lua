...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_spas.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_spas.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 4                                
SWEP.HoldType = "grenade"   
SWEP.Type = "grenade"                     
SWEP.PrintName = "СПСА-14"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
function SWEP:PrimaryAttack()
	if ( !self:CanPrimaryAttack() ) then return end
		...
		local bullet = {}
			...
			bullet.Spread = Vector( self.Primary.Spread * 0.3 , self.Primary.Spread * 0.3, 0)
			bullet.Distance = 1500
		...
		self.Owner:ViewPunch( Angle( -13,0,0 ) )
...
SWEP.VmPos2, SWEP.VmAng2 = Vector(2.8,0,4), Angle(0,0,0)
