...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_groza.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_groza.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "ar2"   
SWEP.Type = "rifle"                            
SWEP.PrintName = "Гром-С14"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 4                              
SWEP.ReloadSound = "ssk/weapons/groza_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
self:SetNWInt("greneclip", 0 ) 
self:SetNWInt("greneclip2", 0 )
self:SetNWInt("ammoclip", 0 ) 
self:SetNWInt("ammoclip2", 0 )
...
SWEP.VmPos, SWEP.VmAng = Vector(3.5,1,-6.6), Angle(0,0,0)
