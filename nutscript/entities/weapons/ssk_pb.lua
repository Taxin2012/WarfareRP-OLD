...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_pb.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_pb.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "pistol"   
SWEP.Type = "pistol"                     
SWEP.PrintName = "ПБ1-1c"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                           
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/pm_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_pb_shot.wav" 
...
function SWEP:PrimaryAttack()
	...
	local bullet = {}
		...
		bullet.Spread = Vector( self.Primary.Spread * 0.08 , self.Primary.Spread * 0.08, 0)
		bullet.Tracer = 1
...
SWEP.VmPos, SWEP.VmAng = Vector(4.5,0,-6.5), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(5.1,0,1.5), Angle(0,0,0)
function SWEP:GetViewModelPosition( pos, ang )
	...
	if (self:GetNWBool( "ZOOM" ) == true) then
		ang:RotateAroundAxis( ang:Right(), 1.5 )
		ang:RotateAroundAxis( ang:Up(), -0.39)
