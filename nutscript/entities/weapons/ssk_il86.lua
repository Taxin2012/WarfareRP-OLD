...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_lr85.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_lr85.mdl"  
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 4                              
SWEP.ReloadSound = "ssk/weapons/l85_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_l85_shot.wav"    
...
if self.Owner:GetAmmoCount( self.Primary.Ammo ) == 0 then return end if (self.Owner:GetActiveWeapon():Clip1() == self.Primary.ClipSize) then return end
    ...
    self:UpdateNextIdle()
    self.Weapon:EmitSound("ssk/weapons/l85_reload.wav")
...
SWEP.VmPos, SWEP.VmAng = Vector(3,1,-5.5), Angle(0,0,0)
