...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_ak47.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_ak74.mdl"
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "ar2"   
SWEP.Type = "rifle"                            
SWEP.PrintName = "АКМ-74/2"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 4                              
SWEP.ReloadSound = "ssk/weapons/ak74_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
function SWEP:Reload()
	...
	self:SetIronsights( false )
	self.Owner:SetNWBool("anim_aim", false)
...
SWEP.VmPos, SWEP.VmAng = Vector(3.6,0,-6.6), Angle(0,0,0)
