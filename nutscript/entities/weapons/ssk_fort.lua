...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_fort.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_fort.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "pistol"   
SWEP.Type = "pistol"                     
SWEP.PrintName = "Фора-12"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Primary.Sound = "ssk/weapons/n_fort_shot.wav"    
...
SWEP.VmPos, SWEP.VmAng = Vector(5.2,0,-6), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.7,0,1.7), Angle(0,0,0)
function SWEP:GetViewModelPosition( pos, ang )
	...
	if (self:GetNWBool( "ZOOM" ) == true) then
		...
		ang:RotateAroundAxis( ang:Forward(), -1.25 )
