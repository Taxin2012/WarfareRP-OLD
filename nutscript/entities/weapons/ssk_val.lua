...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_val.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_val.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "smg"   
SWEP.Type = "sniper"                            
SWEP.PrintName = "СА «ЛАВИНА»"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 3                              
SWEP.ReloadSound = "ssk/weapons/val_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_val_shot.wav"    
...
SWEP.VmPos2, SWEP.VmAng2 = Vector(3.1,0,1.3), Angle(0,0,0)
