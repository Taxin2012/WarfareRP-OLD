...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_gauss.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_gauss.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "smg"   
SWEP.Type = "sniper"                     
SWEP.PrintName = "Гаусс-пушка"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/gauss_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/gauss_shoot.wav"    
...
SWEP.VmPos, SWEP.VmAng = Vector(1.75,0,-6), Angle(0,0,0)
