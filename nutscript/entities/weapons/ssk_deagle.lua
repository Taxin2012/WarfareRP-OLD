...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_desert.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_desert.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "pistol"   
SWEP.Type = "pistol"                     
SWEP.PrintName = "Чёрный ястреб"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/walther_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_desert_eagle_shot.wav"    
...
SWEP.VmPos, SWEP.VmAng = Vector(5.55,0,-6), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.15,0,0.15), Angle(0,0,0)
