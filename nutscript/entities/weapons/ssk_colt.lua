...
SWEP.ViewModel = "models/weapons/ssk/spenser/v_ssk_colt.mdl"    
SWEP.WorldModel = "models/weapons/ssk/spenser/w_ssk_colt.mdl"  
SWEP.AutoSwitchTo = false                     
SWEP.Slot = 1                                
SWEP.HoldType = "pistol"   
SWEP.Type = "pistol"                     
SWEP.PrintName = "Кора-919"               
SWEP.Author = "Spenser"                  
SWEP.Spawnable = true                          
...
SWEP.Weight = 1                                   
SWEP.SlotPos = 0                              
SWEP.ReloadSound = "ssk/weapons/fort_reload.wav"       
SWEP.Instructions = ""  
SWEP.Contact = ""         
SWEP.Purpose = ""      
...
SWEP.Primary.Sound = "ssk/weapons/n_colt1911_shot.wav"    
...
SWEP.VmPos, SWEP.VmAng = Vector(5.1,0,-6), Angle(0,0,0)
SWEP.VmPos2, SWEP.VmAng2 = Vector(4.575,0,1.2), Angle(0,0,0)
function SWEP:GetViewModelPosition( pos, ang )
	...
	if (self:GetNWBool( "ZOOM" ) == true) then
		ang:RotateAroundAxis( ang:Right(), 0.8 )
