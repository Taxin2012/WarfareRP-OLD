...
hook.Add("BuildHelpMenu", "nutBasicHelp", function(tabs)
	...
	tabs["Отношения группировок"] = function(node)
		gui.OpenURL("https://docs.google.com/spreadsheets/d/1kNZQydUB_Nw3xQEOWwXcVLAmYxZjM0lSeFOgcE-nSh4/edit?usp=sharing")
	end
