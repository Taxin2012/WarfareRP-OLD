local PANEL = {}
	...
	function PANEL:Init()
		...
		self.img1 = self:Add( "DImage" )
		self.img1:Dock( TOP )
		self.img1:SetSize(1920, 1080)
		self.img1:SetImage( "ui/f1menu111.png" )
		...
		self.title:SetFont("BigFontForSafe") --шрифт надписи инвентарь и тд
		self.title:SetText("")
