...
LANGUAGE = {
	--Knife = "Туристический нож",
	--pseudodog_tail = "Хвост псевдособаки",
	--burer_hand = "Рука бюрера",
	--bloodsucker_tentacles = "Щупальца кровососа",
	--zombie_hand = "Рука зомби",
	--boars_foot = "Копыто кабана",
	--flesh_eye = "Глаз плоти",
	--gas_can = "Канистра с бензином",
	--noDesc = "",
	--gunInfoDesc = "",
	--gunInfoStat = "",
	--gunInfoAttachments = "",
	--att_bipod = "Сошки",
	--att_laser = "Лазерный прицел",
	--att_foregrip = "Рукоятка",
	--att_muzsup = "Глушитель",
	--att_scope8 = "8-ми кратный прицел",
	--att_scope4 = "4-х кратный прицел",
	--att_holo = "Голографический прицел(На АК - Кобра)",
	--att_rdot = "Коллиматор",
	Loners = "«Одиночки»",
	Strength = "Сила",
	Monday = "Понедельник",
