ITEM.name = "Бронежилет ЧН-1"
ITEM.desc = "Данный бронежилет разрабатывался для проведения поисковых операций в областях с низкой аномальной активностью. Использование довольно качественных материалов повысило устойчивость к износу. \n\nВНИМАНИЕ! \n\n При разборке рекомендуется освободить инвентарь! \n\nХАРАКТЕРИСТИКИ: \n-легкая бронезащита \n-возможно разобрать с помощью лома \n-защищает от радиации при наличии балона"
ITEM.model = 'models/spenser/ssk/outfit/cs_outfit.mdl' --модель_вещи
ITEM.SetModel = 'models/spenser/ssk/new_nebo_01_spen.mdl' --модель_игрока
ITEM.price = 43000
