...
ITEM.functions.misli = { -- sorry, for name order.
	...
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/states/idle/idle_"..math.random(1, 29)..".ogg")
...
ITEM.functions.anik = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/talk/jokes/joke_"..math.random(1, 7)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.atak = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/fight/attack/attack_"..math.random(1, 8)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.prognat = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/threat/back_off/backoff_"..math.random(1, 8)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.good = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/states/loot/loot_good_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.begin = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/states/loot/loot_begin_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.bad = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/states/loot/loot_bad_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.rejoke = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/reactions/joke/reaction_joke_"..math.random(1, 8)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.smex = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/reactions/story/laughter_"..math.random(1, 10)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.prikribayu = { -- sorry, for name order.
	name = "Прикрываю",
	tip = "useTip",
	icon = "icon16/connect.png",
	onRun = function(item)
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/fight/cover_fire/cover_fire_"..math.random(1, 6)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.ostorosno = { -- sorry, for name order.
	name = "Будьте осторожнее",
	tip = "useTip",
	icon = "icon16/connect.png",
	onRun = function(item)
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/fight/detour/detour_"..math.random(1, 10)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.vishu = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/fight/enemy/enemy_"..math.random(1, 10)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.search = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/fight/searching_enemy/search_"..math.random(1, 15)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.soyuznik = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/fight/tolls/tolls_"..math.random(1, 5)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.notalk = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/talk/use/no_default_"..math.random(1, 5)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.ranen = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/help/wounded_heavy/help_"..math.random(1, 7)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.medkit = { -- sorry, for name order.
	name = "Сейчас я тебя вылечу",
	tip = "useTip",
	icon = "icon16/connect.png",
	onRun = function(item)
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/help/wounded/medkit_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.ty = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/merc/help/wounded_thanx/thanx_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
