...
ITEM.functions.misli = { -- sorry, for name order.
	...
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/states/idle/idle_"..math.random(1, 29)..".ogg")
...
ITEM.functions.atak = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/fight/attack/attack_many_"..math.random(1, 8)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.prognat = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/threat/back_off/monolith_backoff_"..math.random(1, 4)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.good = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/states/loot/loot_good_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.begin = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/states/loot/loot_begin_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.bad = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/states/loot/loot_bad_"..math.random(1, 3)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.prikrivayu = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/fight/cover_fire/cover_fire_"..math.random(1, 5)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.prikritie = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/fight/detour/detour_"..math.random(1, 6)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.vishu = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/fight/enemy/enemy_"..math.random(1, 7)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.killed = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/fight/enemy_down/enemy_down_"..math.random(1, 5)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.search = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/fight/searching_enemy/search_"..math.random(1, 6)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.soyuznik = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/fight/tolls/tolls_"..math.random(1, 4)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
...
ITEM.functions.ranen = { -- sorry, for name order.
	...
	local ply = item.player
	if (!ply.timesay or ply.timesay < CurTime()) then
		item.player:EmitSound("zona/stalker/monolith/help/wounded_heavy/help_"..math.random(1, 10)..".ogg")
	ply.timesay = CurTime() + 15
	end
	return false
	end,
