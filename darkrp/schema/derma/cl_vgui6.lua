...
function PANEL:Init()
	...
	gui.OpenURL("https://tinyurl.com/y9qsjwna") --с армейских складов в бар
	end
...
vgui.Register("noteRead6", PANEL, "DFrame")
netstream.Hook("receiveNote6", function() --со свалки на агропром
	noteRead6 = vgui.Create("noteRead6")
end)