...
function PANEL:Init()
	...
	gui.OpenURL("https://tinyurl.com/ybnpvvz8") --с бара на армейские склады
...
vgui.Register("noteRead3", PANEL, "DFrame")
netstream.Hook("receiveNote3", function() --со свалки на агропром
	noteRead3 = vgui.Create("noteRead3")
end)
