...
function PANEL:Init()
	...
	gui.OpenURL("https://tinyurl.com/y74n3w59") --с бара на свалку
...
vgui.Register("noteRead4", PANEL, "DFrame")
netstream.Hook("receiveNote4", function() --со свалки на агропром
	noteRead4 = vgui.Create("noteRead4")
end)
