...
function PANEL:Init()
	...
	gui.OpenURL("https://tinyurl.com/y9qsjwna")  --со свалки в бар
	end
...
vgui.Register("noteRead2", PANEL, "DFrame")
netstream.Hook("receiveNote2", function() --со свалки на агропром
	noteRead2 = vgui.Create("noteRead2")
end)
